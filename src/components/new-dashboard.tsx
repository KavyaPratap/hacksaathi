...
// SIH Carousel Component
const SIHCarousel: React.FC<{ onViewDetails: () => void }> = ({ onViewDetails }) => {
    const carouselItems = [
        {
            title: "Smart India Hackathon 2025",
            description: "Gear up for the nation's biggest innovation challenge.",
            imgSrc: `${supabaseUrl}/storage/v1/object/public/media/sih_banner1.png`,
            imgHint: "innovation challenge"
        },
        {
            title: "Find Your Winning Team",
            description: "Use HackSaathi to connect with skilled innovators.",
            imgSrc: `${supabaseUrl}/storage/v1/object/public/media/sih_banner2.png`,
            imgHint: "team collaboration"
        },
        {
            title: "Solve Real-World Problems",
            description: "Tackle challenges from government and industry.",
            imgSrc: `${supabaseUrl}/storage/v1/object/public/media/sih_banner3.png`,
            imgHint: "problem solving"
        },
        {
            title: "Win Prizes & Recognition",
            description: "Showcase your talent and win big.",
            imgSrc: `${supabaseUrl}/storage/v1/object/public/media/sih_banner4.png`,
            imgHint: "awards trophy"
        }
    ];

    return (
        <section aria-labelledby="sih-carousel" className="w-full max-w-4xl mx-auto">
            <Carousel
                opts={{
                    align: "start",
                    loop: true,
                                    ...
                                    <div className="relative w-full aspect-[21/9]">
                                         ...
                                         <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                                          <div className="absolute bottom-0 left-0 p-6 text-white">
                                            ...
                                            <p className="text-md mt-1 drop-shadow-md">{item.description}</p>
                                        </div>
                                    </div>
                                </Card>
                            </div>
...
const SIHDetailsView: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    return (
            ...
            <Card className="bg-card/70 backdrop-blur-md border-border">
                <CardContent className="p-6">
                    <div className="relative w-full h-60 rounded-lg overflow-hidden mb-6">
                        <Image src={`${supabaseUrl}/storage/v1/object/public/media/sih_details_banner.png`} data-ai-hint="innovation technology" alt="SIH Banner" layout="fill" objectFit="cover" />
                    </div>
                    <h2 className="text-3xl font-bold mb-4">Smart India Hackathon 2025</h2>
                    <div className="space-y-4 text-muted-foreground">
                        <p>The Smart India Hackathon is a nationwide initiative by the Ministry of Education's Innovation Cell to provide students with a platform to solve some of the pressing problems we face in our daily lives, and thus inculcate a culture of product innovation and a mindset of problem-solving.</p>
                        <div className="space-y-2">
                            <h4 className="font-semibold text-foreground">Key Highlights:</h4>
                            <ul className="list-disc list-inside space-y-1">
                                <li>Problem statements from various central government ministries, state governments, and industries.</li>
                                <li>Opportunity to win cash prizes and gain national recognition.</li>
                                <li>Chance to be mentored by industry experts.</li>
                                <li>Potential for your solution to be implemented by government and private sector organizations.</li>
                            </ul>
                        </div>
                        <p>Dates and problem statements for SIH 2025 will be announced soon. Stay tuned to the official SIH portal for updates and start forming your teams now!</p>
                    </div>
                </CardContent>
            </Card>
        </div>
...
export const NewDashboard = () => {
    ...
    const [sihInfoVisible, setSihInfoVisible] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 pb-16 space-y-10 pt-6 relative z-10">
        ...
        {sihInfoVisible ? (
          <SIHDetailsView onBack={() => setSihInfoVisible(false)} />
        ) : (
            <div className="space-y-12">
                <SIHCarousel onViewDetails={() => setSihInfoVisible(true)} />
                <QuickActions />
                <MyTeams />
                <ActivityFeed />
            </div>
