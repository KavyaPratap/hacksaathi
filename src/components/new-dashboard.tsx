            ...
            <Card className="bg-card/70 backdrop-blur-md border-border">
                <CardContent className="p-6">
                    <div className="relative w-full h-60 rounded-lg overflow-hidden mb-6">
                        <Image src="https://picsum.photos/800/400" data-ai-hint="innovation technology" alt="SIH Banner" layout="fill" objectFit="cover" />
                    </div>
...
const QuickActions: React.FC = () => {
  const actions = [
    ...
    { title: "Chat", subtitle: "Messages", icon: <MessageCircle className="w-5 h-5" />, href: "/chat" },
  ];
